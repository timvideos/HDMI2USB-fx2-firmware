# serial-bitbang-loopback

This example shows how to use bitbang UART to send and receive serial data.
It modifies all data received from CDC-ACM OUT endpoint and then sends it
to UART TX queue. Any data received from UART RX queue is sent to host through
CDC-ACM IN endpoint.
