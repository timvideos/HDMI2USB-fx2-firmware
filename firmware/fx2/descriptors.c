		...
		.uvc = {
			...
			.videocontrol = {
				...
				.processing = {
					...
					.bSourceID		= CAMERA_UNIT_ID /* descriptors.highspeed.uvc.videocontrol.camera.bTerminalID */,
					.wMaxMultiplier		= 0,
				...
				.extension = {
					...
					.bNumControls		= 0,
					.bNrInPins		= 1,
					.baSourceID		= { PROCESSING_UNIT_ID /* descriptors.highspeed.uvc.videocontrol.processing.bUnitID */ },
				...
				.output = {
					...
					.bTerminalID		= OUTPUT_UNIT_ID,
					.wTerminalType		= UVC_TT_STREAMING,
					.bAssocTerminal		= 0, // No associated terminal
					.bSourceID		= EXTENSION_UNIT_ID /* descriptors.highspeed.uvc.videocontrol.extension.bUnitID */,
